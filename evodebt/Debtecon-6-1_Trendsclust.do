...
global var2 ihs_ISR10002010 ihs_DAR10002010 ihs_DSR10002010 ihs_ISR10002016 ihs_DAR10002016 ihs_DSR10002016  ihs_ISR10002020    ihs_DAR10002020 ihs_DSR10002020 ihs_DIR10002010 ihs_DIR10002016 ihs_DIR10002020
...
global var2 DAR cro_DAR ihs_DAR DSR cro_DSR ihs_DSR ISR cro_ISR ihs_ISR  loanamount cro_loanamount ihs_loanamount ihs_DIR
...
********** Graph cluster
import delimited using "$git\research_code\evodebt\debttrend_v2.csv", clear
drop panelvar
...
******* Assign 16+15+6 to another category -->ISR
ta sbd_isr
...
keep HHID_panel panelvar $suppvar euc_* sbd_* loanamount1 loanamount2 loanamount3 annualincome1 annualincome2 annualincome3 assets_noland1 assets_noland2 assets_noland3 dsr1 ihs_dsr1 dsr2 ihs_dsr2 dsr3 ihs_dsr3 isr1 ihs_isr1 isr2 ihs_isr2 isr3 ihs_isr3 dar1 ihs_dar1 dar2 ihs_dar2 dar3 ihs_dar3 ihs_annualincome* ihs_assets_noland* ihs_loanamount* ihs_dir1 ihs_dir2 ihs_dir3 ihs_yearly_expenses1 ihs_yearly_expenses2 ihs_yearly_expenses3

***** Reshape
reshape long villageid villagearea annualincome dsr loanamount assets_noland dar isr ihs_isr ihs_dar ihs_dsr ihs_loanamount ihs_annualincome ihs_assets_noland ihs_yearly_expenses ihs_dir, i(HHID_panel) j(time)
...
*** DIR
tabstat ihs_dir, stat(n mean p50 min max)
fre sbd_dir
forvalues i=1(1)4{
local d1="DEC-INC"
local d2="Inc-Dec"
...
local d4="Dec-Dec"
local j="`d`i''"
twoway (line ihs_dir year if sbd_dir==`i', c(L) lcolor(black%10)) ///
, xlabel(2010 2016 2020) xmtick(2010(1)2020) xtitle("Year") ///
ylabel(0(2)12) ymtick(0(1)13) ytitle("Debt to income ratio (ihs)") ///
title("Cluster `i': `j'") ///
aspectratio(0.5) ///
name(gph_dir_`i', replace)
}
...
, xlabel(2010 2016 2020) xmtick(2010(1)2020) xtitle("Year") ///
ylabel(8(2)14) ymtick(8(1)14) ytitle("Yearly expenses (ihs)") ///
title("Cluster `i': `j'") ///
aspectratio(0.5) ///
name(gph_expenses_`i', replace)
}
...
graph combine gph_dir_1 gph_dir_2 gph_dir_3 gph_dir_4, col(2) name(gph_DIR, replace)
graph combine gph_expenses_1 gph_expenses_2 gph_expenses_3, col(2) name(gph_expenses, replace)
