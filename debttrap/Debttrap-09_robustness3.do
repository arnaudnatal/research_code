...
cd"C:\Users\anatal\Documents\DT"
*-------------------------
...
log_wealthbis goldquantity_HH log_income log_saving i.agriHH ///
...
********** Land int
reg diff_w5_dsr ///
c.w5_dsr1##c.w5_dsr1##c.w5_dsr1##c.w5_dsr1##i.agriHH ///
head_female head_age head_age2 head_nonmarried ///
head_occ1 head_occ2 head_occ4 head_occ5 head_occ6 head_occ7 ///
head_educ2 head_educ3 ///
HHsize HH_count_child worker sexratio ///
...
********** Both int
reg diff_w5_dsr ///
c.w5_dsr1##c.w5_dsr1##c.w5_dsr1##c.w5_dsr1##i.dalits##i.agriHH ///
head_female head_age head_age2 head_nonmarried ///
head_occ1 head_occ2 head_occ4 head_occ5 head_occ6 head_occ7 ///
head_educ2 head_educ3 ///
HHsize HH_count_child worker sexratio ///
...
********** Tables
esttab r1 r2 r3 r4 using "Household_agriHH.csv", replace ///
...
HHsize HH_count_child i.agriHH log_wealthbis log_income ///
...
occ1 occ2 occ4 occ5 occ6 occ7 ///
educ2 educ3 educ4 log_saving goldquantity ///
HHsize HH_count_child log_wealthbis log_income i.agriHH ///
dummylock dummydemonetisation dalits ///
village1 village2 village3 village4 village5 village6 village7 village8 village9 $HH
est store r3
...
********** Land x Gender
reg diff_w5_dsr ///
c.w5_dsr1##c.w5_dsr1##c.w5_dsr1##c.w5_dsr1##i.agriHH##i.female ///
age age2 nonmarried ///
occ1 occ2 occ4 occ5 occ6 occ7 ///
educ2 educ3 educ4 log_saving goldquantity ///
HHsize HH_count_child log_wealthbis log_income ///
...
********** Tables
esttab r1 r2 r3 r4 using "Individual_agriHH.csv", replace ///
	b(3) p(3) eqlabels(none) alignment(S) ///
	drop(_cons) ///
	star(* 0.10 ** 0.05 *** 0.01) ///
	cells("b(fmt(2)star)" "se(fmt(2)par)") ///
