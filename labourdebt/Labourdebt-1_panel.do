...
* Add debt no inv
merge 1:1 HHID2010 using "RUME-loans_HH_noinvest", keepusing(imp1_is_tot_HH_noinv totHH_givenamt_repa_noinv loanamount_HH_noinv)
drop _merge
...
* Add debt no inv
merge 1:1 HHID2016 using "NEEMSIS1-loans_HH_noinvest", keepusing(imp1_is_tot_HH_noinv totHH_givenamt_repa_noinv loanamount_HH_noinv)
drop _merge
...
* Add debt no inv
merge 1:1 HHID2020 using "NEEMSIS2-loans_HH_noinvest", keepusing(imp1_is_tot_HH_noinv totHH_givenamt_repa_noinv loanamount_HH_noinv)
drop _merge
...
global quanti8 imp1_is_tot_HH_noinv totHH_givenamt_repa_noinv loanamount_HH_noinv
global quanti $quanti1 $quanti2 $quanti3 $quanti4 $quanti5 $quanti6 $quanti7 $quanti8
