...
*** Combine
grc1leg agri agri_c1 agri_c2, col(3)
...
* Combine
grc1leg wealth wealth_c1 wealth_c2, col(3)
...
* Combine
grc1leg income income_c1 income_c2, col(3)
...
* Combine
grc1leg debt debt_c1 debt_c2, col(3)
...
*** Stat
tabstat remittnet_HH, stat(mean cv p1 p5 p10 q p90 p95 p99) by(year)

*** Graph: Line
global var remittnet_HH
global time year
global id HHID_panel
...
(scatter mean_`var2'2020 n, mcolor(gs0) ms(+) msize(large)) ///
, ///
ytitle("Net remittances (INR 1k)") xtitle("Percentile") ///
xlab(0(20)100) xmtick(0(10)100) ///
ylab(0(30)300) ymtick(0(15)300) ///
note("+ represent the mean.") ///
title("Total") ///
