...
merge 1:1 HHID2010 INDID2010 using "raw/RUME-occup_indiv", keepusing(working_pop dummyworkedpastyear nboccupation_indiv)
keep if _merge==3
drop _merge
...
merge 1:1 HHID2016 INDID2016 using "raw/NEEMSIS1-occup_indiv", keepusing(working_pop dummyworkedpastyear nboccupation_indiv)
keep if _merge==3
drop _merge
...
merge 1:1 HHID2020 INDID2020 using "raw/NEEMSIS2-occup_indiv", keepusing(working_pop dummyworkedpastyear nboccupation_indiv)
keep if _merge==3
drop _merge
...
xtdpdml labourparticipation, inv(dalits) predetermined(L.pca2index) gof std
