...
graph save "ATTR_histo_ES.gph", replace
graph export "ATTR_histo_ES.pdf", as(pdf) replace
...
graph export "ATTR_sub_ES.pdf", as(pdf) replace 
graph save "ATTR_sub_ES.gph", replace
