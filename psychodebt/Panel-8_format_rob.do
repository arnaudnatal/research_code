...
********** Import
import delimited "Reco_margin_`rob'.csv", clear stripquote(yes)
gen n=_n
drop if n<=4
replace n=n-4
...
***
export excel using "Margins_rob.xlsx", sheet("Negotiation_`rob'") sheetmodify cell(A6) nolabel
*************************************
* END
...
***
export excel using "Margins_rob.xlsx", sheet("Management_`rob'") sheetmodify cell(A6) nolabel
*************************************
* END
