...
Table \ref{tab:ame_indebt} :
All else being equal, un point de plus d'EXOP diminue la proba d'être endetté de 2.7 pp.
For a female, all else being equal, un point de plus d'EXOP diminue la proba d'être endetté de 3.7 pp.
For a non-dalit female, all else being equal, un point de plus d'EXOP diminue la proba d'être endetté de 8.5 pp.

Table \ref{tab:ame_loans} :
