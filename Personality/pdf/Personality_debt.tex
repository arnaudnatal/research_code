...
We find that certain personality traits such as XXX are generally significantly associated with XXX. 
...
Our preliminary results call for further exploration of the nature and the variety of socioeconomic barriers facing disadvantaged groups in rural India.
\end{resab}
...
For 4,000 individuals from Netherland, \cite{Pinjisakikool2017} shows that all the Big-5 personality traits are good predictor of financial risk tolerance as \cite{Bucciol2017} whose show that agreeableness, cynical hostility and anxiety are good predictor of financial risk taking for 11,000 individuals from USA (negative correlation).
...
\cite{Brown2014} find that extraversion and agreeableness are positively associated with the level of debt held while conscientiousness is negatively correlated with the level of unsecured debt for 10,000 individuals of UK and \cite{Forlicz2019} show differences between debtors and debt-free individuals in terms of conscientiousness, honesty, attittude towards money and shoppping for 3,700 individuals from Poland, Spain, Romania and Italy.
...
As we discuss in section \ref{subsection:data}, the incidence of debt is largely under-estimate \citep{Jones1994} and micro-level studies indicates an incidence around 80-90\% \citep{Guerin2013a, Jones1994, Dreze1997, Reboul2021}.
...
Dalits, have higher incidence of indebtedness but borrow smaller amounts and more frequently from ambulant lenders.
They borrow less for economic reason than non-dalits but more for household expenditures. %\citep{Guerin2013a, Guerin2014a}.
Finally, they have the lower access\footnote{In part, because of they does not have necessary guarantee (i) such as good land (irrigated one and good location), specific know-how (ii), or because they self-excluded themselves because dalits are persuaded to fail \citep{Guerin2013a}.} to bank loans while it offer the best conditions with low interest rate, higher amounts, and long duration \citep{Chavan2007}.
...
Recents crises such as microfinance crisis \citep{Nair2011, Sriram2010}, demonetisation \citep{GuerinDemo2017} or lockdown \citep{Guerin2021, Guerin2021b} have exacerbate disparities between caste and sex to the detriment of dalits and female, making understanding individual and household debt even more essential.
...
Debt represent more than money, it is a social link closely nested in social relationship and individual defining them and thinking of them according to their indebtedness \citep{Guerin2014}. 
Moreover, trust and reputation play a crucial role by conditioning creditworthiness \citep{Guerin2021}.
This sociological and anthropological structuralist approcahes recognises that individuals cannot be considered outside of the social relations that make up the collective structure \citep{Polanyi1944}. 
...
Then, we analyse how does debt change over time as \PTCS~ changes? (iii).% how \PTCS~ influences the debt trajectory (iii)? and how does debt change over time as \PTCS~ changes? (iv).
...
%We, therefore, implement our own exploratory factor analysis to identitfy personality traits.
...
The results show that 2016-17 \hl{cognitive skill --whatever the specification-- are not correlated with the probability of being indebted} in 2020-21 at 95\% \cl~(cl), except for literacy which is positively correlated for the average female at 90\% cl.

However, three of the personality traits are correlated at the 95\% cl. 
Factor 1 as \hl{OP-EX is negatively correlated with the probability for the average middle-upper caste individual of being in debt and the relationship seems to be clarified for the average non-dalit female}: \ote, when OP-EX increase by one \sd, the probability of being in debt decrease by 11.1 percentage point (pp).
The magnitude of the relationship is little less strong for \hl{Factor 3} as \textit{Porupillatavan} (-8.4 pp) for the same average individual. 
Last, Factor 2 as \hl{CO is positively correlated (8.5 pp) for the average middle-upper male}, \aebe.
...
\hl{Raven score is correlated }with the total amount of debt at 95\% \cl~ for the average dalits female: \aebe, when Raven score increase by one \sd, predicted total loan amount increase by 21,000 \rupee.
...
\hl{For the average individual, OP-EX is positively correlated}.
The relationship seems to be clarified for the average non-dalit individual and especially for the \hl{average non-dalit male} for who one more sd in OP-EX is associated by a increasing of 49,000 \rupee~ of the total loan amount, \ote.
Always for the average middle-upper caste male, the strengh of the negative relationship with \hl{CO is high enough (-64,000 \rupee)} compared to other relationship. 
Last, \hl{AG is negatively correlated for the average dalits and especially for the average dalit female} (-15,000 \rupee).
...
The results show that 2016-17 \hl{cognitive skill are not correlated} with the individual DSR at 95\% cl neither at 90\%.

As for the previous analysis, \hl{Factor 1 is positively correlated with the share of the annual income dedicated to debt (capital and interest) repayment and especially for average female and average dalits female} at 95\% \cl.
Indeed, for the average dalit female, when OP-EX increase by one \sd~, the predicted DSR increase by 98 pp, \aebe.
\hl{CO is negatively correlated for the average individuals} and the magnitude of the correlation is similar to that of Factor 1 (49 pp in more for OP-EX and 48 pp in less for CO, \ote).
...
Only Factor 4 as \hl{Emotional stability, numeracy and literacy are correlated} at 95\% \cl~ with the total loan amount (see Figure \ref{fig:qreg_loanamount}).
...
Regarding individual \hl{DSR, the coefficient of OP-EX varies across the distribution} (see Figure \ref{fig:qreg_dsr}) with ME being higher at the end of the distribution at 95\% cl.
...
\figaround{fig:qreg_loanamount}
\figaround{fig:qreg_dsr}
...
% \textit{Porupillatavan} is a good predictor of the stability of the debt situation (never in debt or always in debt).
% It is positively correlated with the probability of never being in debt and thus negatively correlated with the probability of always being in debt, at 95\% cl.
...
As cognitive skills, only \hl{literacy is positively correlated with the amount of debt at 95\% risk of error for the average male, average non-dalit and especially the average non-dalit male}: when literacy is one more \sd, the predicted total amount borrowed increase by 81,000 \rupee, \ote.
...
Regarding personality traits, \hl{EX is negatively correlated for the average dalit and especially for the average dalit male} at 95\% cl (-41,000 \rupee).
...
\tabaround{tab:ame_fe_loanamount}
...
At 95\% \cl~, \hl{neither personality traits, neither cognitive skills are correlated with the total loan amount}.
...
The statistics reveal a number of important insights and recognize that behavioural and structuralist are meaningful and need to be articulated to deepend understand indebtedness.
...
%First, we relate our results to other studies on \PTCS~ and debt --which take all places in northern countries.
%Then, we discuss our findings in by mobilizing a more contextual literature on the one hand debt and on the other hand \PTCS.

	% ******************************
	\subsection{How \PTCS~ shape indebtedness situation?}
	% ******************************

An interesting finding of this paper is that cognitive skills appear to play a limited role on individual debt, \ote, while personality traits seems to be significantly associated with debt.
...
This result illustrate \dev{le fait que tout le monde ou presque soit endetté, pas besoin d'avoir une certaine intelligence, (chose qui peut paraitre necessaire pour les tdint et tout, et bah non)  Notion de financial literacy?}

Looking at personality traits, we have first identifies the crucial role of OP-EX and CO in shaping debt with heterogenous contribution according to caste and gender.
As shown in the literature \citep{Brown2014}, OP-EX is positively correlated with the probability of holding debt and positively correlated with the amount of debt.
Our results suggest negative relationship with the probabilty of being in debt only for non-dalit female and positive relationship with the level of debt (total amount and DSR) for non-dalit male and dalit female.
This interesting pattern can be explained by \dev{what?}.
\cite{Brown2014, Donnelly2012} find that conscientiousness is inversely associated with the level of unsecured debt.
Our findings corroborate for the total loan amount and the individual DSR, but we find positive correlation with the probability of being in debt while \cite{Nyhus2001, Brown2014} find negative relationship.
It \dev{suggest that} individuals who are more conscientious are more able to ``manage their money through greater levels of financial self-control.''


AG negatively correlated
The only correlation with 5\% risk of error for Agreeableness is negative and with the amount of debt.
\cite{Brown2014} find positive correlation.
\cite{Nyhus2001} find not correlation with debt.

Thus, yes personality traits shape indebtedness situation in rural India while cognitive skills not.

	% ******************************
	\subsection{How the \PTCS~ varies across the indebtedness distribution?}
	% ******************************

However, on the level of the debt, Raven test is correlated (positively) with the total amount of debt for dalit female, \aebe, numeracy and literacy are negatively correlated with the amount of debt in the first 30-40\% of the distribution and positively correlated in the last decile.
ES negatively at median
OPEX positively at last 20-10\% 

OPEX change à la fin tout comme le cognitif. 


	% ******************************
	\subsection{How does debt change over time as \PTCS~ changes?}
	% ******************************
Literacy positively correlated 
EX negatively correlated

Using panel data variation, it appear that extraversion is negatively correlated with the amount of debt, especially for dalit male.


Burden of debt nothing but amount of debt literacy and EX.

	% ******************************
	\subsection{Do individuals manage to differentiate themselves through their skils?}
	% ******************************

Dalit female with higher AG and Raven have higher amount of debt than other, \ote, and higher opex = higher burden.
Les non dalit female elle se différencient avec OPEX et Poru car réduit leur proba d'être endetté.

Dalit male EX negative avec le amount fe
Non dalit male CO augmente proba d'etre endetté
OPEX augmente montant de la dette et CO le diminue
et literacy augmente amount fe

Aborder le fait que DSR rejoint un peu la question de la negociation du remboursement

Oui, certaines se démarquent, en bien ou en mal, mais dans tous les groupes, certains individus arrivent à mieux s'en sortir que d'autres graces à leurs compétences.
...
Numerous study have highlighted disparities in terms of debt between caste and gender.
Nous sommes les seules à avoir creusé encore plus précisément pour savoir si des gens s'en sortaient mieux que d'autres à l'intérieur de ces identités sociales.
...
% \paragraph{\PTCS~ and debt: comparisons with not}

% Openness-Extraversion and Conscientiousness appears as the most predicives personality traits.
% Regarding Openness-Extraversion, 
% Regarding Emotional Stability, \cite{Nyhus2001} find negative relationship with the probability of being in debt while \cite{Brown2014} cannot find relationship.
% Our results corroborate with these latter: except for non-dalit female with the amount of debt (negatively correlated), we do not find any correlation with 5\% risk of error.
% It suggest that ES is not important in influencing incidence and level of debt, \aebe, which is interesting \dev{in the context of the positive association found in the existing literature relating to financial optimism and debt.}




% La réputation et la confiance sont des éléments clés dans notre contexte:
% trust play a crucial role since both largely condition creditworthiness (and access to employment). 
% The embeddedness of economic transactions in personal relationships, typical of informal economies (Platteau 1994; Hart 2000), remains a predominant reality in India (Harriss-White 2003).
% As observed elsewhere , informal sources persist, for several reasons. They are very flexible, which is crucial given the irregularity of income. For 84 percent of informal loans, the terms are not fixed in advance and borrowers repay when they can. Contrary to what is often claimed in the literature or media, their cost is not, on average, higher than formal sources in the region studied here (Reboul et al. 2019). Almost none of them require collateral (80 percent require only personal informal agreement). Subjective creditworthiness, reputation and trust (the three terms are equivalent in Tamil - nambikai) are the key factors in lenders’ selection.
% ). Broadly speaking, trust depends on the personal and social characteristics of the contracting parties and their respective appreciation, on a process and memory of repeated interactions (Hilger and Nordman 2020)

% As with any lender, the fabric of trust is then based on credit history and repayment behaviour. Reputation is public information, available at the village level. Reputation encompasses family history, seriousness and “morality” of different family members. Bad payers are quickly identified and discriminated against by lenders, but also by employers or labour intermediaries. They may also affect children’s marriage. Reputation is therefore an essential asset in households’ portfolios, which people constantly seek to preserve and cultivate. Here too, conflicts are legion. Disappearing from the village for a while can be a way of postponing a debt. But permanent migration remains exceptional and the attachment to the village is such that payment defaults are rare.
...
% Trust and crisis ? Lockdown \citep{GuerinDemo2017, Guerin2021}

% \citep{Guerin2021, Hilger2020}
...
% \begin{itemize}
% \item[Proba]
% \item No CS correlated
% \item OP-EX negatively correlated for the average non-dalit female
% \item \textit{Porupillatavan} negatively correlated for the average non-dalit female
% \item CO positively correlated for the average middle-upper male

% \item[Amount]
% \item Raven positively correlated for the average dalit female
% \item OP-EX positively correlated for the average non-dalit male
% \item CO negatively correlated for the average non-dalit male
% \item AG negatively correlated for the average dalit female

% \item[IDSR]
% \item No CS correlated
% \item OP-EX positively correlated for the average dalit female
% \item CO negatively correlated for the average individual

% \item[qreg-Amount]
% \item ES negatively correlated at P50
% \item Numeracy negatively correlated at P30
% \item Numeracy positively correlated at P90
% \item Literacy negatively correlated at P30-P40
% \item Literacy positively correlated at P90

% \item[qreg-IDSR]
% \item OP-EX positively correlated at P80-P90

% \item[FE-Amount]
% \item Literacy positively correlated for the average non-dalit male
% \item EX negatively correlated for the average dalit male
...
% \begin{itemize}
% \item[Groups]
% \item Dalit female = 3 (Raven, AG: + amount) (OP-EX: + IDSR)
% \item Dalit male = 1 (EX: - fe amount) 
% \item Non-dalit female = 2 (OP-EX, Poru: - proba)
% \item Non-dalit male = 4 (CO: + proba) (OP-EX: + amount) (CO: - amount) (literacy: + fe amount)
