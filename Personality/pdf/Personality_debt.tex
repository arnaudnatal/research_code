...
Other focus on education through educational attainment, course grades or standardised achievement test scores but few researchers have been interested in the relationship with household and individual finances while it is a growing area of interest.%\footnote{This renewed interest led the Journal of Economic Literature (JEL) to create a field in its own right under the code G5 -- Household finances, in .}.
First, households are more implicated in financial decision, partially due to the privatisation of retirement pensions, liberalisation of the loan market, increase in credit purchase and the financial innovation has enlarged the set of financial tools and complicated the choices \citep{Guiso2013}.
...
They instruments conscientiousness and emotional stability with childhood trauma on Dutch dataset and they show that people in the bottom quintile of personality traits are 10 times more likely to experience financial distress than those in the top quintile.
...
The average amount of debt per household strongly increased between 1951 and 2012 (from \rupee83 to \rupee33k) with an increase in the share of formal debt (from 7 to 56\% for rural households) and, thus, a decreasing in the share of traditional informal debt (from 93 to 43\% for rural households) \citep{Rajakumar2019}.
...
Moreover, females in the poorest households have the highest borrowing responsibilities and dalit females tend to face higher debt burden than non-dalits one.
...
Then, we analyse how debt change over time as \PTCS~ change? (iii).% how \PTCS~ influences the debt trajectory (iii)? and how does debt change over time as \PTCS~ changes? (iv).
...
Overall, it aim to articulating behavioural (\PTCS) and structuralist approaches (social identity), two disjoint disciplinary theories.
...
%We, therefore, implement our own exploratory factor analysis to identify personality traits.
...
% In order to best measure the debt, we could combine objective and subjective measures as \cite{Aniola2012} do in European Countries, but this brings the risk that all households will find themselves categorised as over-indebted according to the measure used \citep{Chichaibelu2018}.
...
Indeed, we have data for two individuals from the same household and these latter sharing resources and pooling others (incomes, assets for instance).%\footnote{See \cite{Lazear1988} or \cite{Bonke2015} more recently.}.
...
% We use the same vector of control variables than for the two previous approaches, we also cluster the error at household level and we compute ME at representative values (sex and caste at representative values).
...
In terms of assets, middle-upper castes households are three times richer than dalits on average --respectively \rupee1,493k and \rupee487k in 2016-17.
...
The reverse assessment is true for salaried jobs in agriculture: between 2016-17 and 2020-21 the share of male increase by 47\% (from 16\% to 24\%) but females remain relatively more numerous (27.42\% in 2016-17 and 29.58\% in 2020-21). 
...
In 2016-17, it appears that males tend to have higher score for each traits: they are more open to experience, conscientious, extroverted, agreeable and emotional stable.
...
Distribution of conscientiousness is more platikurtic and shifted to the right in 2016-17 than in 2020-21 for males: taken as a whole, males are less conscientious in 2020-21 compared 2016-17.
The assessment is reverse for females.
Distributions of agreeableness of 2020-21 are more platikurtic for males and females: taken as a whole, a more important share of male/female is very/less agreeable in 2020-21 compared to 2016-17.
Conversely, distributions of 2020-21 for emotional stability are more leptokurtic for males and females.
Concerning cognitive skills, distributions of Raven score are more shifted to the left in 2016-17 than in 2020-21: taken as a whole, a more important share of male/female has a low score at Raven test in 2020-21 compared to 2016-17.
For numeracy and literacy test, distributions are more shifted to the right in 2016-17 than in 2020-21: taken as a whole, a more important share of male/female has a high score in 2020-21 compared to 2016-17.
...
According to specifications, the representative values are: (1) the average individual (``All''); (2) the average male (``Male'') and the average female (``Female''); (3) the average non-dalit or the average middle-upper caste (``MUC'') and the average dalit (``Dalits''); (4) the average non-dalit male (``MUC male''), the average dalit male (``Dalits male''), the average non-dalit female (``MUC female'') and the average dalit female (``Dalits female'').
...
% The IMR is insignificant across all four estimations \dev{(Be careful of three-way interaction)}, indicating that self-selection does not significantly affect total loan amount of debt after controlling for \PTCS and other control variables.
...
At 90\% cl, numeracy is also correlated for the average dalit female, but positively and with lower magnitude (-\rupee16k).
Relationship between debt and Raven is reverses for the average non-dalit female with higher magnitude than for average dalit female (+\rupee33k).
...
% The IMR is insignificant across all four estimations \dev{(Be careful of three-way interaction)}, indicating that self-selection does not significantly affect individual debt service ratio after controlling for \PTCS and other control variables.
...
Conscientiousness is negatively correlated for the average individual and the magnitude of the correlation is similar to Factor 1 (49 pp in more for openness-extraversion and 48 pp in less for conscientiousness, \ote).

\textit{Porupillatavan} and emotional stability are correlated with the amount of debt if we accept 10\% risk of error, especially for the average non-dalit female.
While the relationship is positive for \textit{Porupillatavan}, the one with openness-extraversion is negative and stronger (respectively +93 pp and -136 pp).
...
The role of \PTCS~ is heterogenous depending on the gender, the caste and the outcome.
In what follows, we use our findings and literature on \PTCS~ and indebtedness to provide answers to our questions three questions.
...
\dev{Travaux sur la solidarité intra caste ?}
...
We find negative relationship with the amount of debt for dalits, suggesting that trusted individuals (agreeableness encapsulates the concept of reliability, trust) have more facilities in their repayment and therefore we may be less inclined to borrow to repay a loan. \dev{à vérifier avec les données}

Overall, our findings tend to show that personality traits are good predictor of future individual debt while cognitive skills, in our context, not shape individual debt.
...
It can be explained by the fact that individuals with higher literacy level can be the one with a better job in terms of higher income and thus individuals who need lower amount of debt to live on a daily basis. \dev{à vérifier avec les données}
...
\dev{essayer de trouver une petite piste quand même}
...
Highly openned and extraverted individuals take more risk when their established debt potentially resulting in a higher DSR.
...
When literacy level increase through time, individuals have access to a wider range of financial tools (mobile finance with phone, formal loans, etc.) perhaps bevause of a better understanding of contracts, that potentially increase their level of debt, \aebe.
...
It echoes the work on aspirations \citep{Mukherjee2017, Sarkar2020}.
...
% Conscientiousness, extraversion, agreeableness and openness to experience have an association with informal debt.
% \end{hyp}
...
%Indeed, around 90\% of labour is informal [in the sense of absence of social insurance] and 85\% of non-agricultural workforce is informal \citep{Mehrotra2019}.
