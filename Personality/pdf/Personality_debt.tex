...
\dev{Proches, ces deux termes ne visent pas à mesurer la même chose}.
...
\dev{Phrase pour parler des enjeux politiques de la compréhension de la dette au niveau indiv avant de parler des crises.}
...
\dev{Phrase pour expliquer rapido pourquoi ca a été important durant les crises.}
...
The results show that 2016-17 \hl{cognitive skill --whatever the specification-- are not correlated with the probability of being indebted} in 2020-21 at 90-95\% \cl~(cl), except for literacy which is positively correlated for the average female.
...
The magnitude of the relationship is little less strong for Factor 3 as \textit{Porupillatavan} (-8.4 pp). 
...
ME of OP-EX is 20,000 \rupee~ at P80 and 45,000 \rupee~ at P90 if we accept 10\% risk of error, \aebe.
...
The statistics reveal a number of important insights. 
First, the role of \PTCS~ is heterogenous depending on the gender and the caste of individuals,  diverse and highly fragmented along the lines of caste, class and localisation in terms of access to debt, debt purpose and price of the loan. 
In what follows, we use insights from our qualitative analysis to further document and complement the analyses on debt fragmentation. 
We discuss respectively fragmentation along caste and location, because for these social factors the qualitative analyses provide most complementary insights to the statistics.
