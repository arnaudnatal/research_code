...
Concerning cogntive skills and especially numeracy and literacy test, majority of individuals have higher --or equal-- score in 2020-21 than in 2016-17 (see Appendix \ref{section:stab_big5}) which coroborate with the lifelong learning theory\footnote{``Development after formal education: the continuing development of knowledge and skills that people experience after formal education and throughout their lives'' \citep{London2011}. See \cite{London2011} for furthers details.}. 
About Raven test the stability is more mixed.
It appear that an important share of the population have a stable or higher score across in 2020-21, but a significant share faces a drop in score.
\cite{Raven2000} show that 
...
Quantile debt regressions consider specific parts of the conditional distribution of the debt and indicate the influence of the PT\&CS variables on conditional debt.
...
To fully understand the results we do not use interaction variables and we compute ME at means to investigate the relationship between debt and PT\&CS for the average individual at specific percentile of the distribution (respectively at P10, P25, P50, P75 and P90).
...
We use the same vector of control variables than for the two previous approach.
...
Unlike the previous approach, we do not use personality traits from factor analysis insofar as factor for 2016-17 are different from those for 2020-21\footnote{The resulting factor from factor analysis of 2016-17 and 2020-21 are not interpreted the same way. We cannot therefore analyse the evolution of a factor while the way we compute Big-5 personality traits remain the same in 2016-17 and 2020-21.}.
...
To interpret the results, marginal effects (ME) at representative values on the predicted value of the PT\&CS are reported for the four specifications as describe previously (without interaction (1), with sex interaction (2), with caste interaction (3), with sex \& caste interaction (4)).
...
We will therefore speaks in terms of ``one standard deviation'' more of PT\&CS.
