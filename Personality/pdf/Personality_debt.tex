...
It can be explained by the fact that individual with higher literacy level can be the one with better job (in terms of higher income) and thus individuals who need lower amount of debt to live on a daily basis. \dev{to check}
