...
The average amount of debt per household strongly increased between 1951 and 2012 (from \rupee83 to \rupee32,522) with an increase in the share of formal debt (from 7 to 56\% for rural households) and, thus, a decreasing in the share of traditional informal debt (from 93 to 43\% for rural households) \citep{Rajakumar2019}.
...
In terms of assets, middle-upper caste households are three times richer than dalits on average --respectively \rupee1,493k and \rupee487k in 2016-17.
...
We find negative relationship with the amount of debt for dalits, suggesting that trusted people (agreeableness encapsulates the concept of reliability, trust) have more facilities in their repayment and therefore we may be less inclined to borrow to repay a loan. \dev{to check}
...
It can be explained by the fact that individual with higher literacy level can be the one with a better job (in terms of higher income) and thus individuals who need lower amount of debt to live on a daily basis. \dev{to check}
