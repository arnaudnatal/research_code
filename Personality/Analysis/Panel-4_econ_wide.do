...
**********Margin excel
********** 1
foreach x in indebt_indiv1 loanamount_indiv10001 DSR_indiv1 loans_indiv1 over40_indiv1 delta2_DSR_indiv1 delta2_ISR_indiv1 delta2_loanamount_indiv1 delta2_loans_indiv1{
preserve
use"margin_`x'", clear
...
********** 2
foreach x in indebt_indiv2 loanamount_indiv10002 DSR_indiv2 loans_indiv2 over40_indiv2 delta2_DSR_indiv2 delta2_ISR_indiv2 delta2_loanamount_indiv2 delta2_loans_indiv2{
preserve
use"margin_`x'", clear
label define cog 1"Factor 1 (std)" 2"Factor 2 (std)" 3"Factor 3 (std)" 4"Factor 4 (std)" 5"Factor 5 (std)" 6"Raven" 7"Numeracy" 8"Literacy", replace
label values _deriv cog
...
********** 3
foreach x in indebt_indiv3 loanamount_indiv10003 DSR_indiv3 loans_indiv3 over40_indiv3 delta2_DSR_indiv3 delta2_ISR_indiv3 delta2_loanamount_indiv3 delta2_loans_indiv3{
preserve
use"margin_`x'", clear
label define cog 1"Factor 1 (std)" 2"Factor 2 (std)" 3"Factor 3 (std)" 4"Factor 4 (std)" 5"Factor 5 (std)" 6"Raven" 7"Numeracy" 8"Literacy", replace
label values _deriv cog
...
********** 4
foreach x in indebt_indiv4 loanamount_indiv10004 DSR_indiv4 loans_indiv4 over40_indiv4 delta2_DSR_indiv4 delta2_ISR_indiv4 delta2_loanamount_indiv4 delta2_loans_indiv4{
preserve
use"margin_`x'", clear
label define cog 1"Factor 1 (std)" 2"Factor 2 (std)" 3"Factor 3 (std)" 4"Factor 4 (std)" 5"Factor 5 (std)" 6"Raven" 7"Numeracy" 8"Literacy", replace
label values _deriv cog
...
********** Heckman
foreach x in loanamount_indiv10001 DSR_indiv1{
preserve
use"margin_heck_`x'", clear
label define cog 1"Factor 1 (std)" 2"Factor 2 (std)" 3"Factor 3 (std)" 4"Factor 4 (std)" 5"Factor 5 (std)" 6"Raven" 7"Numeracy" 8"Literacy", replace
label values _deriv cog
decode _deriv, gen(deriv)
gen at=.
...
label var ci_lb "[95% Conf."
label var ci_ub "Interval]"
export excel using "margins1.xlsx", sheet("heck`x'", replace) firstrow(varlabels)
gen margin_str=strofreal(margin, "%9.3f")
gen stat_str=strofreal(statistic, "%9.3f")
keep _deriv margin_str stat_str
gen xo="("
...
*cap ssc inst sxpose
sxpose, clear
export excel using "margins.xlsx", sheet("heck`x'1", replace) firstrow(varlabels)
restore 
}

********** 2
foreach x in loanamount_indiv10002 DSR_indiv2{
preserve
use"margin_heck_`x'", clear
label define cog 1"Factor 1 (std)" 2"Factor 2 (std)" 3"Factor 3 (std)" 4"Factor 4 (std)" 5"Factor 5 (std)" 6"Raven" 7"Numeracy" 8"Literacy", replace
label values _deriv cog
...
label var ci_lb "[95% Conf."
label var ci_ub "Interval]"
export excel using "margins2.xlsx", sheet("heck`x'", replace) firstrow(varlabels)
gen margin_str=strofreal(margin, "%9.3f")
gen stat_str=strofreal(statistic, "%9.3f")
keep _deriv at margin_str stat_str
gen xo="("
...
*cap ssc inst sxpose
sxpose, clear
export excel using "margins.xlsx", sheet("heck`x'2", replace) firstrow(varlabels)
restore 
}

********** 3
foreach x in loanamount_indiv10003 DSR_indiv3{
preserve
use"margin_heck_`x'", clear
label define cog 1"Factor 1 (std)" 2"Factor 2 (std)" 3"Factor 3 (std)" 4"Factor 4 (std)" 5"Factor 5 (std)" 6"Raven" 7"Numeracy" 8"Literacy", replace
label values _deriv cog
...
label var ci_lb "[95% Conf."
label var ci_ub "Interval]"
export excel using "margins3.xlsx", sheet("heck`x'", replace) firstrow(varlabels)
gen margin_str=strofreal(margin, "%9.3f")
gen stat_str=strofreal(statistic, "%9.3f")
keep _deriv at margin_str stat_str
gen xo="("
...
*cap ssc inst sxpose
sxpose, clear
export excel using "margins.xlsx", sheet("heck`x'3", replace) firstrow(varlabels)
restore 
}


********** 4
foreach x in loanamount_indiv10004 DSR_indiv4{
preserve
use"margin_heck_`x'", clear
label define cog 1"Factor 1 (std)" 2"Factor 2 (std)" 3"Factor 3 (std)" 4"Factor 4 (std)" 5"Factor 5 (std)" 6"Raven" 7"Numeracy" 8"Literacy", replace
label values _deriv cog
...
label var ci_lb "[95% Conf."
label var ci_ub "Interval]"
export excel using "margins4.xlsx", sheet("heck`x'", replace) firstrow(varlabels)
gen margin_str=strofreal(margin, "%9.3f")
gen stat_str=strofreal(statistic, "%9.3f")
keep _deriv at margin_str stat_str
gen xo="("
...
*cap ssc inst sxpose
sxpose, clear
export excel using "margins.xlsx", sheet("heck`x'4", replace) firstrow(varlabels)
restore 
}
