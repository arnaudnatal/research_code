...
restore
* Combine
graph combine dyn slope, col(2) title("Dalits") name(comb, replace)
set graph on
graph display comb
graph export "Dyn_dal.png", replace
...
restore
* Combine
graph combine dyn slope, col(2) title("Non-dalits") name(comb, replace)
set graph on
graph display comb
graph export "Dyn_ndal.png", replace
...
restore
* Combine
graph combine dyn slope, col(2) title("No land") name(comb, replace)
set graph on
graph display comb
graph export "Dyn_nland.png", replace
...
restore
* Combine
graph combine dyn slope, col(2) title("Landowner") name(comb, replace)
set graph on
graph display comb
graph export "Dyn_land.png", replace
