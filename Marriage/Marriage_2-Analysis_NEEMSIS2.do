...
*Dummy asso
tabstat peoplewedding totalmarriagegiftamount1000 marriagetotalcost, stat(n mean sd q max) by(dummyasso) 

*Nbercontact
tab contactphone sex, row nofreq
tabstat peoplewedding totalmarriagegiftamount1000, stat(n mean sd q max) by(contactphone)

*Leaders
tab dummycontactleaders1 sex
tabstat peoplewedding totalmarriagegiftamount1000, stat(n mean sd q max) by(dummycontactleaders1)
...
tabstat yratepaid, stat(n mean sd p50) by(loanreasongiven)

tabstat yratepaid if loanreasongiven==8, stat(n mean sd p50) by(loanlender_new2020)
tabstat yratepaid if loanreasongiven!=8, stat(n mean sd p50) by(loanlender_new2020)

tabstat yratepaid if loanreasongiven==8 & loanlender_new2020==1, stat(n mean sd p1 p5 p10 q p90 p95 p99 min max)
