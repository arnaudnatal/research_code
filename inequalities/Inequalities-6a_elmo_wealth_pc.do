...
****************************************
* WEALTH decomposition GE by caste
****************************************
use"panel_v3", clear
...
***** Std Err.
/*
ineqerr assets_total_pc if year==2010, reps(200)
ineqerr assets_total_pc if year==2016, reps(200)
ineqerr assets_total_pc if year==2020, reps(200)
*/
...
****************************************
* WEALTH - ELMO (2008) : avec 3 groupes (les trois castes)
****************************************
use"panel_v3", clear
...
qui ineqdeco assets_total_pc, by(comb`x')
...
cls
* 2010
ineqdeco assets_total_pc if year==2010, by(jatis)

cls
* 2016
ineqdeco assets_total_pc if year==2016, by(jatis)

cls
* 2020
ineqdeco assets_total_pc if year==2020, by(jatis)
...
****************************************
* WEALTH - Decomposition GE by jatis for Middle
****************************************
macro drop _all 
use"panel_v3", clear
...
****************************************
* WEALTH - Decomposition GE by jatis for Upper
****************************************
macro drop _all 
use"panel_v3", clear
