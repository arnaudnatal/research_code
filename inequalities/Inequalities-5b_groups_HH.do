...
*********** Combine
grc1leg inc ass, note("{it:Note:} For 405 households in 2010, 492 in 2016-2017, and 625 in 2020-2021.", size(vsmall))
...
ta q_inc caste if year==2026, row nofreq chi2
...
twoway ///
(bar sum1 quintile if time==4, barwidth(1.9)) ///
(rbar sum1 sum2 quintile if time==4, barwidth(1.9)) ///
(rbar sum2 sum3 quintile if time==4, barwidth(1.9)) ///
, ///
xlabel(1 3 5 7 9 12,valuelabel) xtitle("") ///
ylabel(0(10)100) ytitle("Percent") ///
title("2026") ///
...
grc1leg compo1 compo2 compo3 compo4, col(2) name(comp, replace) note("{it:Note:} For 405 households in 2010, 492 in 2016-2017, and 625 in 2020-2021.", size(vsmall))
...
ta q_ass caste if year==2026, row nofreq chi2
...
graph bar dalits middle upper if time==2, over(cat, label(angle(45))) title("2016-2017") ytitle("Percent") legend(order(1 "Dalits" 2 "Middle castes" 3 "Upper castes") col(3) pos(6)) name(g2, replace) ylabel(0(10)80)

graph bar dalits middle upper if time==3, over(cat, label(angle(45))) title("2020-2021") ytitle("Percent") legend(order(1 "Dalits" 2 "Middle castes" 3 "Upper castes") col(3) pos(6)) name(g3, replace) ylabel(0(10)80)

graph bar dalits middle upper if time==4, over(cat, label(angle(45))) title("2026") ytitle("Percent") legend(order(1 "Dalits" 2 "Middle castes" 3 "Upper castes") col(3) pos(6)) name(g4, replace) ylabel(0(10)80)
set graph on

grc1leg g1 g2 g3 g4, col(2) name(inc, replace) note("{it:Note:} For 405 households in 2010, 492 in 2016-2017, and 625 in 2020-2021.", size(vsmall))
...
graph bar dalits middle upper if time==2, over(cat, label(angle(45))) title("2016-2017") ytitle("Percent") legend(order(1 "Dalits" 2 "Middle castes" 3 "Upper castes") col(3) pos(6)) name(g2, replace) ylabel(0(10)100)

graph bar dalits middle upper if time==3, over(cat, label(angle(45))) title("2020-2021") ytitle("Percent") legend(order(1 "Dalits" 2 "Middle castes" 3 "Upper castes") col(3) pos(6)) name(g3, replace) ylabel(0(10)100)

graph bar dalits middle upper if time==4, over(cat, label(angle(45))) title("2026") ytitle("Percent") legend(order(1 "Dalits" 2 "Middle castes" 3 "Upper castes") col(3) pos(6)) name(g4, replace) ylabel(0(10)100)
set graph on

grc1leg g1 g2 g3 g4, col(2) name(ass, replace) note("{it:Note:} For 405 households in 2010, 492 in 2016-2017, and 625 in 2020-2021.", size(vsmall))
...
cls
* 2026
ineqdeco monthlyincome if year==2026, by(caste)
...
cls
* 2026
ineqdeco assets_total if year==2026, by(caste)
...
label define year 1"2010" 2"2016-2017" 3"2020-2021" 4"2026"
label values year year
* 
graph bar (mean) pop income wealth, over(year) over(caste) ///
ylabel(0(10)60) ymtick(0(5)60) ytitle("Percent") ///
legend(order(1 "Share in the population" 2 "Share in the total monthly income" 3 "Share in the total wealth") col(1) pos(6)) scale(1.2) note("{it:Note:} For 405 households in 2010, 492 in 2016-2017, and 625 in 2020-2021.", size(vsmall))
