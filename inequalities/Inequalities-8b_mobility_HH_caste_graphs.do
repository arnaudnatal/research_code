...
***** Assets 
import excel "CF_caste.xlsx", sheet("assHH_rank") firstrow clear
...
, title("Wealth rank mobility" "2010 to 2016-17") ///
ytitle("") ylabel(.2(.2).6) ///
...
(connected index_upp alpha, color(plg1)) ///
(rarea CI_upper_upp CI_lower_upp alpha, color(plg1%10)) ///
, title("Wealth rank mobility" "2016-17 to 2020-21") ///
ytitle("") ylabel(.1(.2).5) ///
xtitle("α") xlabel(0(.5)1) ///
legend(order(1 "Dalits" 3 "Middle castes" 5 "Upper castes") pos(6) col(3)) ///
...
***** Income 
import excel "CF_caste.xlsx", sheet("incHH_rank") firstrow clear
label define timeframe 1"2010 - 2016-17" 2"2016-17 - 2020-21"
label values timeframe timeframe
label define sample 1"Overall" 2"Downward" 3"Upward"
label values sample sample
...
(connected index_upp alpha, color(plg1)) ///
(rarea CI_upper_upp CI_lower_upp alpha, color(plg1%10)) ///
, title("Monthly income rank mobility" "2010 to 2016-17") ///
ytitle("") ylabel(.2(.2).6) ///
xtitle("α") xlabel(0(.5)1) ///
legend(order(1 "Dalits" 3 "Middle castes" 5 "Upper castes") pos(6) col(3)) ///
...
(connected index_upp alpha, color(plg1)) ///
(rarea CI_upper_upp CI_lower_upp alpha, color(plg1%10)) ///
, title("Monhtly income rank mobility" "2016-17 to 2020-21") ///
ytitle("") ylabel(.2(.2).6) ///
xtitle("α") xlabel(0(.5)1) ///
legend(order(1 "Dalits" 3 "Middle castes" 5 "Upper castes") pos(6) col(3)) ///
...
graph export "graph_HH/CFcasterank_HH.png", as(png) replace
...
***** Assets 
import excel "CF_caste.xlsx", sheet("assHH_level") firstrow clear
label define timeframe 1"2010 - 2016-17" 2"2016-17 - 2020-21"
label values timeframe timeframe
label define sample 1"Overall" 2"Downward" 3"Upward"
label values sample sample
...
(connected index_upp alpha, color(plg1)) ///
(rarea CI_upper_upp CI_lower_upp alpha, color(plg1%10)) ///
, title("Wealth mobility" "2010 to 2016-17") ///
...
(connected index_upp alpha, color(plg1)) ///
(rarea CI_upper_upp CI_lower_upp alpha, color(plg1%10)) ///
, title("Wealth mobility" "2016-17 to 2020-21") ///
ytitle("") ylabel(0(.3).9) ///
xtitle("α") xlabel(0(.5)1) ///
legend(order(1 "Dalits" 3 "Middle castes" 5 "Upper castes") pos(6) col(3)) ///
...
***** Income 
import excel "CF_caste.xlsx", sheet("incHH_level") firstrow clear
label define timeframe 1"2010 - 2016-17" 2"2016-17 - 2020-21"
label values timeframe timeframe
label define sample 1"Overall" 2"Downward" 3"Upward"
label values sample sample
...
(connected index_upp alpha, color(plg1)) ///
(rarea CI_upper_upp CI_lower_upp alpha, color(plg1%10)) ///
, title("Monthly income mobility" "2010 to 2016-17") ///
ytitle("") ylabel(.0(1)5) ///
xtitle("α") xlabel(0(.5)1) ///
legend(order(1 "Dalits" 3 "Middle castes" 5 "Upper castes") pos(6) col(3)) ///
...
(connected index_upp alpha, color(plg1)) ///
(rarea CI_upper_upp CI_lower_upp alpha, color(plg1%10)) ///
, title("Monthly income mobility" "2016-17 to 2020-21") ///
...
graph export "graph_HH/CFcastelevel_HH.png", as(png) replace
