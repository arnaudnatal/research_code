...
ytitle("Wealth (1k rupees)") ylabel(0(2000)10000) ///
legend(off) ///
note("Pearson {it:p}=0.051; Spearman {it:p}=0.081", size(vsmall)) ///
name(g4, replace) scale(1.2) 


********** Combine
graph combine g1 g2 g3 g4, col(2) note("{it:Note:} For 405 households in 2010, 492 in 2016-2017, and 625 in 2020-2021.", size(vsmall))
