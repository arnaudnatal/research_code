...
(connected income incgroup if time==4) ///
, ///
title("Average monthly income") ///
xlabel(1(1)10) xtitle("Decile of monthly income") ///
ylabel(0(10)60) ytitle("1k rupees") ///
legend(order(1 "2010" 2 "2016-2017" 3 "2020-2021" 4 "2026") pos(6) col(4)) ///
...
twoway ///
(area sum1 incgroup if time==4) ///
(rarea sum1 sum2 incgroup if time==4) ///
(rarea sum2 sum3 incgroup if time==4) ///
(rarea sum3 sum4 incgroup if time==4) ///
(rarea sum4 sum5 incgroup if time==4) ///
(rarea sum5 sum6 incgroup if time==4) ///
(rarea sum6 sum7 incgroup if time==4) ///
(rarea sum7 sum8 incgroup if time==4) ///
, ///
xlabel(1(1)10) xtitle("Decile of monthly income") ///
ylabel(0(10)100) ytitle("Percent") ///
title("2026") ///
...
grc1leg compo1 compo2 compo3 compo4, col(2) name(inc, replace)
...
(connected assets assgroup if time==4) ///
, ///
title("Average wealth") ///
xlabel(1(1)10) xtitle("Decile of wealth") ///
ylabel(0(2000)10000) ytitle("1k rupees") ///
legend(order(1 "2010" 2 "2016-2017" 3 "2020-2021" 4 "2026") pos(6) col(2)) ///
...
twoway ///
(area sum1 assgroup if time==4) ///
(rarea sum1 sum2 assgroup if time==4) ///
(rarea sum2 sum3 assgroup if time==4) ///
(rarea sum3 sum4 assgroup if time==4) ///
(rarea sum4 sum5 assgroup if time==4) ///
(rarea sum5 sum6 assgroup if time==4) ///
, ///
xlabel(1(1)10) xtitle("Decile of wealth") ///
ylabel(0(10)100) ytitle("Percent") ///
title("2026") ///
...
grc1leg compo1 compo2 compo3 compo4, col(2) name(compo, replace)
...
********** Combine graph
graph combine inc ass, col(2) title("Percent change in Gini") note("{it:Note:} For 405 households in 2010, 492 in 2016-2017, and 625 in 2020-2021.", size(vsmall))
